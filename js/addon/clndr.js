...
;(function ( $, window, document, undefined ) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><p onclick='RequestUsableSchedule();' class='clndr-previous-button'>previous</p></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><p onclick='RequestUsableSchedule();' class='clndr-next-button'>next</p></div>" +
    "</div>" +
  ...
  Clndr.prototype.createDayObject = function(day, monthEvents) {
    ...
    // uniqueness of IDs.
    extraClasses += " " + day.format("YYYYMMDD");
